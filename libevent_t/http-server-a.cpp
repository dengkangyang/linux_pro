...
void signal_handler(int sig) 
{
	...
	case SIGQUIT:
	case SIGINT:
		event_base_loopbreak(base);  //终止侦听event_dispatch()的事件侦听循环，执行之后的代码
		break;
	}
}
...
void httpd_handler(struct evhttp_request *req, void *arg) 
{
	...
	evbuffer_copyout(req->input_buffer, post_data, evbuffer_get_length(req->input_buffer));
...
int main(int argc, char **argv)
{
	...
	evhttp_bind_socket(http_server, httpd_option_listen, httpd_option_port);
