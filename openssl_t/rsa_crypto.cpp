...
int main(int argc, char** argv)
{
	...
	unsigned char* input_string = (unsigned char*)calloc(strlen(argv[1]) + 1, sizeof(unsigned char));
	...
	unsigned char*  encrypt_string = (unsigned char*)calloc(RSA_size(encrypt_rsa), sizeof(unsigned char));
